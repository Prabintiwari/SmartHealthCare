...
const Login = ({ showLogin, setShowLogin }) => {
  ...
  return (
    <div className="fixed flex justify-center items-center z-[1] w-full h-full bg-[#00000090]">
      <div className=" flex flex-col gap-3 m-auto items-start min-w-80 sm:min-w-96 border bg-white dark:bg-slate-300 border-slate-400 rounded-xl text-sm p-8 shadow-2xl backdrop-filter backdrop-blur-sm relative">
        ...
        <FontAwesomeIcon
          ...
          className="absolute  text-xl p-1 hover:text-red-500 bg-transparent cursor-pointer top-0 right-0 duration-300"
        />
